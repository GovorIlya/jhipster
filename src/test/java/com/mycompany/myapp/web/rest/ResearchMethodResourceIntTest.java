...
public class ResearchMethodResourceIntTest {
    ...
    private static final String DEFAULT_HEAD_STRING = "AAAAAAAAAA";
    private static final String UPDATED_HEAD_STRING = "BBBBBBBBBB";
    ...
    private static final byte[] DEFAULT_METHOD_IMAGE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_METHOD_IMAGE = TestUtil.createByteArray(2, "1");
    private static final String DEFAULT_METHOD_IMAGE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_METHOD_IMAGE_CONTENT_TYPE = "image/png";
    ...
    public static ResearchMethod createEntity(EntityManager em) {
        ResearchMethod researchMethod = new ResearchMethod()
            .headString(DEFAULT_HEAD_STRING)
            .researchMethod(DEFAULT_RESEARCH_METHOD)
            .methodImage(DEFAULT_METHOD_IMAGE)
            .methodImageContentType(DEFAULT_METHOD_IMAGE_CONTENT_TYPE)
            .file(DEFAULT_FILE)
    ...
    public void createResearchMethod() throws Exception {
        ...
        assertThat(testResearchMethod.getHeadString()).isEqualTo(DEFAULT_HEAD_STRING);
        assertThat(testResearchMethod.getResearchMethod()).isEqualTo(DEFAULT_RESEARCH_METHOD);
        assertThat(testResearchMethod.getMethodImage()).isEqualTo(DEFAULT_METHOD_IMAGE);
        assertThat(testResearchMethod.getMethodImageContentType()).isEqualTo(DEFAULT_METHOD_IMAGE_CONTENT_TYPE);
    ...
    public void getAllResearchMethods() throws Exception {
        ...
        restResearchMethodMockMvc.perform(get("/api/research-methods?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].headString").value(hasItem(DEFAULT_HEAD_STRING.toString())))
            .andExpect(jsonPath("$.[*].researchMethod").value(hasItem(DEFAULT_RESEARCH_METHOD.toString())))
            .andExpect(jsonPath("$.[*].methodImageContentType").value(hasItem(DEFAULT_METHOD_IMAGE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].methodImage").value(hasItem(Base64Utils.encodeToString(DEFAULT_METHOD_IMAGE))))
    ...
    public void getResearchMethod() throws Exception {
        ...
        restResearchMethodMockMvc.perform(get("/api/research-methods/{id}", researchMethod.getId()))
            ...
            .andExpect(jsonPath("$.headString").value(DEFAULT_HEAD_STRING.toString()))
            .andExpect(jsonPath("$.researchMethod").value(DEFAULT_RESEARCH_METHOD.toString()))
            .andExpect(jsonPath("$.methodImageContentType").value(DEFAULT_METHOD_IMAGE_CONTENT_TYPE))
            .andExpect(jsonPath("$.methodImage").value(Base64Utils.encodeToString(DEFAULT_METHOD_IMAGE)))
    ...
    public void updateResearchMethod() throws Exception {
        ...
        updatedResearchMethod
            .headString(UPDATED_HEAD_STRING)
            .researchMethod(UPDATED_RESEARCH_METHOD)
            .methodImage(UPDATED_METHOD_IMAGE)
            .methodImageContentType(UPDATED_METHOD_IMAGE_CONTENT_TYPE)
            .file(UPDATED_FILE)
        ...
        ResearchMethod testResearchMethod = researchMethodList.get(researchMethodList.size() - 1);
        assertThat(testResearchMethod.getHeadString()).isEqualTo(UPDATED_HEAD_STRING);
        assertThat(testResearchMethod.getResearchMethod()).isEqualTo(UPDATED_RESEARCH_METHOD);
        assertThat(testResearchMethod.getMethodImage()).isEqualTo(UPDATED_METHOD_IMAGE);
        assertThat(testResearchMethod.getMethodImageContentType()).isEqualTo(UPDATED_METHOD_IMAGE_CONTENT_TYPE);
