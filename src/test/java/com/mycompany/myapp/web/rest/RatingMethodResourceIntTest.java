...
public class RatingMethodResourceIntTest {
    ...
    private static final String DEFAULT_RATING_HEAD = "AAAAAAAAAA";
    private static final String UPDATED_RATING_HEAD = "BBBBBBBBBB";

    private static final String DEFAULT_RATING_METHOD = "AAAAAAAAAA";
    private static final String UPDATED_RATING_METHOD = "BBBBBBBBBB";

    private static final byte[] DEFAULT_RATING_IMAGE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_RATING_IMAGE = TestUtil.createByteArray(2, "1");
    private static final String DEFAULT_RATING_IMAGE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_RATING_IMAGE_CONTENT_TYPE = "image/png";
    ...
    public static RatingMethod createEntity(EntityManager em) {
        RatingMethod ratingMethod = new RatingMethod()
            .ratingHead(DEFAULT_RATING_HEAD)
            .ratingMethod(DEFAULT_RATING_METHOD)
            .ratingImage(DEFAULT_RATING_IMAGE)
            .ratingImageContentType(DEFAULT_RATING_IMAGE_CONTENT_TYPE)
    ...
    public void createRatingMethod() throws Exception {
        ...
        assertThat(testRatingMethod.getRatingHead()).isEqualTo(DEFAULT_RATING_HEAD);
        assertThat(testRatingMethod.getRatingMethod()).isEqualTo(DEFAULT_RATING_METHOD);
        assertThat(testRatingMethod.getRatingImage()).isEqualTo(DEFAULT_RATING_IMAGE);
        assertThat(testRatingMethod.getRatingImageContentType()).isEqualTo(DEFAULT_RATING_IMAGE_CONTENT_TYPE);
    ...
    public void getAllRatingMethods() throws Exception {
        ...
        restRatingMethodMockMvc.perform(get("/api/rating-methods?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ratingHead").value(hasItem(DEFAULT_RATING_HEAD.toString())))
            .andExpect(jsonPath("$.[*].ratingMethod").value(hasItem(DEFAULT_RATING_METHOD.toString())))
            .andExpect(jsonPath("$.[*].ratingImageContentType").value(hasItem(DEFAULT_RATING_IMAGE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].ratingImage").value(hasItem(Base64Utils.encodeToString(DEFAULT_RATING_IMAGE))))
    ...
    public void getRatingMethod() throws Exception {
        ...
        restRatingMethodMockMvc.perform(get("/api/rating-methods/{id}", ratingMethod.getId()))
            ...
            .andExpect(jsonPath("$.ratingHead").value(DEFAULT_RATING_HEAD.toString()))
            .andExpect(jsonPath("$.ratingMethod").value(DEFAULT_RATING_METHOD.toString()))
            .andExpect(jsonPath("$.ratingImageContentType").value(DEFAULT_RATING_IMAGE_CONTENT_TYPE))
            .andExpect(jsonPath("$.ratingImage").value(Base64Utils.encodeToString(DEFAULT_RATING_IMAGE)))
    ...
    public void updateRatingMethod() throws Exception {
        ...
        updatedRatingMethod
            .ratingHead(UPDATED_RATING_HEAD)
            .ratingMethod(UPDATED_RATING_METHOD)
            .ratingImage(UPDATED_RATING_IMAGE)
            .ratingImageContentType(UPDATED_RATING_IMAGE_CONTENT_TYPE)
        ...
        RatingMethod testRatingMethod = ratingMethodList.get(ratingMethodList.size() - 1);
        assertThat(testRatingMethod.getRatingHead()).isEqualTo(UPDATED_RATING_HEAD);
        assertThat(testRatingMethod.getRatingMethod()).isEqualTo(UPDATED_RATING_METHOD);
        assertThat(testRatingMethod.getRatingImage()).isEqualTo(UPDATED_RATING_IMAGE);
        assertThat(testRatingMethod.getRatingImageContentType()).isEqualTo(UPDATED_RATING_IMAGE_CONTENT_TYPE);
